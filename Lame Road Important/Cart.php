...
<body id="body" style="background-color: #eeeeee;">
  ...
  <!--/.Navbar -->
  <!--Body-->
  <div id="card" class="text-center container w-75 mt-4" style="display:none;">
    <div class="row" id="cardrow">
      ...
      <div class="shadow-none card col-4 filter Volkswagen Sedan" style="display:block;">
        <div class="card-body">
          <div class="view overlay">
              <img id="cardimg" class="card-img-top" src="img/Cars/Vento.png" alt="Card image cap">
          </div>
          <div id="cardbody">
          <form action="" method="POST">
          <div class="col">
      ...
      <div class="shadow-none card col-4 filter Volkswagen Sedan" style="display:block;">
        <div class="card-body">
          <div class="view overlay">
              <img id="cardimg" class="card-img-top" src="img/Cars/Passat.png" alt="Card image cap">
          </div>
          <div id="cardbody">
          <form action="" method="POST">
          <div class="col">
      ...
      <div class="shadow-none card col-4 filter Volkswagen SUV" style="display:block;">
        <div class="card-body">
          <div class="view overlay">
              <img id="cardimg" class="card-img-top" src="img/Cars/Tiguan.png" alt="Card image cap">
          </div>
          <div id="cardbody">
          <form action="" method="POST">
          <div class="col">
      ...
      <div class="shadow-none card col-4 filter Toyota SUV" style="display:block;">
        <div class="card-body">
          <div class="view overlay">
              <img id="cardimg" class="card-img-top" src="img/Cars/Fortuner.png" alt="Card image cap">
          </div>
          <div id="cardbody">
          <form action="" method="POST">
          <div class="col">
      ...
      <div class="shadow-none card col-4 filter Toyota HB" style="display:block;">
        <div class="card-body">
          <div class="view overlay">
              <img id="cardimg" class="card-img-top" src="img/Cars/Corolla.png" alt="Card image cap">
          </div>
          <div id="cardbody">
          <form action="" method="POST">
          <div class="col">
